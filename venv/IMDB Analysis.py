...
sns.countplot(y = Top_10_prod_com.production_company, palette='Blues')
plt.xlabel('Releases')
...
print(top10df.shape)
top10df['Total'] = top10df.loc[:,("WWGross_income_millions")]
print(top10df.head(10))

#1bcont. From ascertaining value in above list, I could find a smart way to drop th
print(334338-129662)

...
#Graph 1. Production Company by the Amount of the films release
...
#Graph 2. From ascertaining value in above list, I could not find a smart way to drop the values into the pie chart
...
#Graph 3 Top Production Company by top 10 grossing movies
...
#Graph 4. Second pie chart including 3 new companies
...
#Graph 5. Number of releases per Calender year
